                          ...
                          <div style={{ marginTop: 6, fontSize: "0.7rem", color: "rgba(167,139,250,0.7)" }}>
                            {e.thumb
                              ...
                              : /instagram\.com|instagr\.am/i.test(e.sourceUrl || "")
                                ? <>Tick Select, then Extract selected / Extract all — or Extract this card. Every carousel slide is fetched via Apify then saved here, so their CDN link (usually ~4.5 days) can't expire on you.</>
